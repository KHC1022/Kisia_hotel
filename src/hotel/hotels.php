            ...
            <div class="search-box">
                <div class="search-row">
                    <div class="search-input">
                        ...
                        <input type="text" placeholder="호텔 이름 또는 위치 검색">
                    </div>
                ...
                <div class="filter-controls">
                    <div class="filter-group">
                        ...
                        <div class="filter-dropdown">
                            ...
                            <div class="filter-section">
                                <h4 class="filter-section-title">편의시설</h4>
                                <div class="filter-options">
                                    <label class="filter-option">
                            ...
                            <div class="filter-section">
                                <h4 class="filter-section-title">호텔 등급</h4>
                                <div class="filter-options">
                                    <label class="filter-option">
        ...
        <div class="hotels-grid">
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-info">
                    <h3 class="hotel-name">그랜드 럭셔리 호텔</h3>
                    ...
                    <div class="hotel-actions">
                        <a href="hotel-detail.php?hotel=paradise" class="detail-btn">상세보기</a>
                    </div>
                </div>
            </div>
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-info">
                    <h3 class="hotel-name">비치 파라다이스 호텔</h3>
                    <p class="hotel-location">
                        <i class="fas fa-map-marker-alt"></i>
                        마이애미, 미국
                    </p>
                    ...
                    <div class="hotel-rating">
                        ...
                        <span class="review-count">(158개 후기)</span>
                    </div>
                    <div class="hotel-price">
                        ₩300,000 <span class="price-per-night">/ 박</span>
                    </div>
                    <div class="hotel-actions">
                        <a href="hotel-detail.php?hotel=signiel" class="detail-btn">상세보기</a>
                    </div>
                </div>
            </div>
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-info">
                    <h3 class="hotel-name">마운틴 뷰 호텔</h3>
                    <p class="hotel-location">
                        <i class="fas fa-map-marker-alt"></i>
                        덴버, 미국
                    </p>
                    ...
                    <div class="hotel-rating">
                        ...
                        <span class="review-count">(127개 후기)</span>
                    </div>
                    <div class="hotel-price">
                        ₩200,000 <span class="price-per-night">/ 박</span>
                    </div>
                    <div class="hotel-actions">
                        <a href="hotel-detail.php?hotel=parkhyatt" class="detail-btn">상세보기</a>
                    </div>
                </div>
            </div>
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-info">
                    <h3 class="hotel-name">시티 센터 호텔</h3>
                    <p class="hotel-location">
                        <i class="fas fa-map-marker-alt"></i>
                        서울, 대한민국
                    </p>
                    ...
                    <div class="hotel-rating">
                        ...
                        <span class="rating-score">4.5</span>
                        <span class="review-count">(189개 후기)</span>
                    </div>
                    <div class="hotel-price">
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-info">
                    <h3 class="hotel-name">오션 뷰 리조트</h3>
                    <p class="hotel-location">
                        <i class="fas fa-map-marker-alt"></i>
                        제주도, 대한민국
                    </p>
                    ...
                    <div class="hotel-rating">
                        ...
                        <span class="rating-score">5.0</span>
                        <span class="review-count">(245개 후기)</span>
                    </div>
                    <div class="hotel-price">
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-info">
                    <h3 class="hotel-name">히스토릭 팰리스 호텔</h3>
                    <p class="hotel-location">
                        <i class="fas fa-map-marker-alt"></i>
                        파리, 프랑스
                    </p>
                    ...
                    <div class="hotel-rating">
                        ...
                        <span class="review-count">(178개 후기)</span>
                    </div>
                    <div class="hotel-price">
